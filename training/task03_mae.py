...
""" 
This script trains a multi-modal autoencoder for traffic category
...
$ python task03_mae.py --epochs 20 --batch_size 128 --fold_number 3
...
def train_multimodal_autoencoder(epochs: int, batch_size: int, K: int):
    ...
    mae = MultimodalAE(model_path=f'../data/task03/mae/{fname}_k{K}',
    ...
    embeddings.to_csv(f'../data/task03/embeddings/mae_embeddings_k{K}.csv')
